...
// ==============================================================
#ifndef __predictive_controjbC__HH__
#define __predictive_controjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predictive_controjbC) {
    ...
    SC_CTOR(predictive_controjbC):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
