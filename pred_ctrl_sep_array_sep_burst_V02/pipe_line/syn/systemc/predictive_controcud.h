...
// ==============================================================
#ifndef __predictive_controcud__HH__
#define __predictive_controcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predictive_controcud) {
    ...
    SC_CTOR(predictive_controcud):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
