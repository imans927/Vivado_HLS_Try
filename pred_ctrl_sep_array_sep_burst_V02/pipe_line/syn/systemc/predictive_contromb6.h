...
// ==============================================================
#ifndef __predictive_contromb6__HH__
#define __predictive_contromb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predictive_contromb6) {
    ...
    SC_CTOR(predictive_contromb6):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
