...
#pragma HLS INTERFACE s_axilite port=return bundle=crtl_bus
 ...
 int i;
  ...
  float U_KK_a[3*4];
  float Y_Hat_a[6*4*4];
#pragma HLS ARRAY_PARTITION variable=&Y_Hat_a complete dim=1
# 36 "pred_controller.cpp"

  float R_Hat_a[8*4];
#pragma HLS ARRAY_PARTITION variable=&R_Hat_a complete dim=1
# 37 "pred_controller.cpp"

  float V_Mul_H_Inv_a[9*4*4];
#pragma HLS ARRAY_PARTITION variable=&V_Mul_H_Inv_a complete dim=1
# 38 "pred_controller.cpp"

  float V_Gen_a[9*4*4];
#pragma HLS ARRAY_PARTITION variable=&V_Gen_a complete dim=1
# 39 "pred_controller.cpp"

  float V_Gen_a_cpy[9*4*4];
#pragma HLS ARRAY_PARTITION variable=&V_Gen_a_cpy complete dim=1
# 40 "pred_controller.cpp"

  float H_Hat_Inv_a[9*4*4];
#pragma HLS ARRAY_PARTITION variable=&H_Hat_Inv_a complete dim=1
# 41 "pred_controller.cpp"
  ...
  float U_unc_kk[3*4];
#pragma HLS ARRAY_PARTITION variable=&U_unc_kk complete dim=1
