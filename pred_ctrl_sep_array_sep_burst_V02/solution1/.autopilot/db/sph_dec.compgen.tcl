...
set ID 58
set hasByteEnable 0
set MemName sph_dec_switch_pokbM
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename U_unc \
    op interface \
    ports { U_unc_address0 { O 4 vector } U_unc_ce0 { O 1 bit } U_unc_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'U_unc'"
}
}
