...
set ID 18
set hasByteEnable 0
set MemName unconstrained_temp
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename R_Hat_a \
    op interface \
    ports { R_Hat_a_address0 { O 5 vector } R_Hat_a_ce0 { O 1 bit } R_Hat_a_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'R_Hat_a'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Y_Hat_a \
    op interface \
    ports { Y_Hat_a_address0 { O 7 vector } Y_Hat_a_ce0 { O 1 bit } Y_Hat_a_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'Y_Hat_a'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Y_Ref_KK_a \
    op interface \
    ports { Y_Ref_KK_a_address0 { O 3 vector } Y_Ref_KK_a_ce0 { O 1 bit } Y_Ref_KK_a_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename U_KK_a \
    op interface \
    ports { U_KK_a_address0 { O 4 vector } U_KK_a_ce0 { O 1 bit } U_KK_a_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename V_Mul_H_Inv_a \
    op interface \
    ports { V_Mul_H_Inv_a_address0 { O 8 vector } V_Mul_H_Inv_a_ce0 { O 1 bit } V_Mul_H_Inv_a_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'V_Mul_H_Inv_a'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 28 \
    name unconstrained_r \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename unconstrained_r \
    op interface \
    ports { unconstrained_r_address0 { O 4 vector } unconstrained_r_ce0 { O 1 bit } unconstrained_r_we0 { O 1 bit } unconstrained_r_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'unconstrained_r'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename theta_kk \
    op interface \
    ports { theta_kk_address0 { O 4 vector } theta_kk_ce0 { O 1 bit } theta_kk_we0 { O 1 bit } theta_kk_d0 { O 32 vector } theta_kk_q0 { I 32 vector } } \
} "
} else {
