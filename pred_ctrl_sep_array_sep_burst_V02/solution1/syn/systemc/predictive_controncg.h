...
// ==============================================================
#ifndef __predictive_controncg__HH__
#define __predictive_controncg__HH__
#include "ACMP_dadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predictive_controncg) {
    ...
    SC_CTOR(predictive_controncg):  ACMP_dadd_U ("ACMP_dadd_U") {
        ACMP_dadd_U.clk(clk);
