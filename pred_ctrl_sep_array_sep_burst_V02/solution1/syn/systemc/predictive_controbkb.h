...
// ==============================================================
#ifndef __predictive_controbkb__HH__
#define __predictive_controbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predictive_controbkb) {
    ...
    SC_CTOR(predictive_controbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
