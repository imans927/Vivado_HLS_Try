...
// ==============================================================
#ifndef __predictive_controocq__HH__
#define __predictive_controocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predictive_controocq) {
    ...
    SC_CTOR(predictive_controocq):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
